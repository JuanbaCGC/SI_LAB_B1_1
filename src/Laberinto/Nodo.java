...
public class Nodo implements Comparable<Nodo> {
	...
	public Nodo(Estado estado, Nodo padre, double costo_acumulado, int profundidad, int id, int heuristica, String accion, double valor) {
		this.estado = estado;
		this.padre = padre;
	...
	public Nodo(Estado estado, Nodo padre, double costo_acumulado, int profundidad, int id, int heuristica, String accion) {
		this.estado = estado;
		this.padre = padre;
		this.costo_acumulado = costo_acumulado;
		this.profundidad = profundidad;
	...
	public String toString() {
		return "["+ id + "][Estado: " + estado + ", padre : " + padre + ", costo: " + costo_acumulado + ", profundidad: " + profundidad + ", heurística: " + heuristica + ", acción: " + accion + ", f: " + valor + "]";
	}
